...
CREATE TABLE IF NOT EXISTS `enrollment_records` (
    ...
    `year_level` VARCHAR(30) NOT NULL, -- e.g., '1st Year', '2nd Year', '3rd Year', '4th Year', 'Graduated'
    `academic_year` VARCHAR(20) NOT NULL, -- e.g., '2026-2027'
    `semester` VARCHAR(30) NOT NULL, -- e.g., 'First Semester', 'Second Semester', 'Summer'
...
CREATE TABLE IF NOT EXISTS `academic_records` (
    ...
    `record_reference` VARCHAR(100) NULL, -- Book/Page or Archive Reference
...
CREATE TABLE IF NOT EXISTS `payments` (
    ...
    `payment_method` ENUM('Cash', 'GCash', 'Maya', 'Bank Transfer', 'Official Receipt (Cashier)') NOT NULL DEFAULT 'Cash',
...
-- ------------------------------------------------------------------------------
-- 16. TRACKING NUMBER SEQUENCE TABLE (Ensures Atomic Sequential Tracking Generation)
-- ------------------------------------------------------------------------------
...
-- ------------------------------------------------------------------------------
-- 17. SYSTEM SETTINGS TABLE (Configurable Operational Parameters)
-- ------------------------------------------------------------------------------
